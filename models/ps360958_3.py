...
class MyModel(BaseModel):
    ...
    def build_model(self):
        ...
        with tf.variable_scope("new") as scope0:
            c1 = tf.layers.conv2d(conv7, 128, (5,5), activation=tf.nn.relu, name="conv9")
            mp1 = tf.layers.max_pooling2d(c1, 3, 3, name="maxpool4")
            c2 = tf.layers.conv2d(mp1, 64, (5,5), activation=tf.nn.relu, name="conv10")
            mp2 = tf.layers.max_pooling2d(c1, 3, 3, name="maxpool5")
